...
public class DataInitializer {
    ...
    CommandLineRunner InitUsers(UserService userService) {
        return args -> {
            User user1 = CreateUser("Jean", "1234567489", "USER", "Jean", "Doe", "jean.doe@example.com",
                    "123-456-7890");
            User user2 = CreateUser("Paul", "1234567489", "USER", "Paul", "Smith", "paul.smith@example.com",
                    "123-456-7891");
            User user3 = CreateUser("Jacques", "1234567489", "USER", "Jacques", "Brown", "jacques.brown@example.com",
                    "123-456-7892");
            ...
            User user6 = CreateUser("Louise", "1234567489", "USER", "Louise", "Jones", "louise.jones@example.com",
                    "123-456-7895");
            User user7 = CreateUser("Pierre", "1234567489", "USER", "Pierre", "Garcia", "pierre.garcia@example.com",
                    "123-456-7896");
